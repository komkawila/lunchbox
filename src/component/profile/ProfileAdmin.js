        ...
        if (user != null) {
            if (user.length != 0) {
                ...
                axios.get(api+"login/"+user.uid).then((res) => {
                        ...
                        setphoneNumberA(res.data[0].phonenumber);
                        setsexA(res.data[0].gender);
                        setaddressA(res.data[0].address);
                });
            }
        } else {
    ...
    return (
        <div className="container-login">
            <div className="box registor-admin">
                <h1> แก้ไขข้อมูล สถาบันวิจัย <br />วิทยาศาสตร์และเทคโนโลยี</h1>
